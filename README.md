...
- A generic OpenStreetMap clinic is only classified as Medical Centre when its mapped name indicates a GP surgery, health/medical centre or medical practice. This prevents specialist clinics from being relabelled as GP facilities.
